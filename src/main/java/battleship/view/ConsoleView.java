...
public class ConsoleView implements View {
	...
	public static String player = ConsoleColor.ANSI_YELLOW + "[%s]" + ConsoleColor.ANSI_RESET + " ";
	public static String prompt = ConsoleColor.ANSI_BLUE + "%s" + ConsoleColor.ANSI_RESET + "\n";
	public static String question = ConsoleColor.ANSI_CYAN + "%s" + ConsoleColor.ANSI_RESET + "\n";
	...
	public void showGameMode() {
		System.out.printf(question, "Please select game mode");
	...
	public void showNameSelect(int playerId) {
		System.out.printf(question, "Player " + playerId + " - give your name");
		System.out.printf(prompt, ">>>");
	...
	public void showShipPlacementModeView(String playerName) {
		System.out.printf(player, playerName);
		System.out.printf(question, "Would you like to set the ships yourself");
	...
	public void showShipsToPlace(String playerName, List<ShipClass> shipsToPlace) {
		System.out.printf(player, playerName);
		System.out.printf(question, "Please select ship to place");
	...
	public void showShipPositioningView(ShipClass shipClass) {
		System.out.printf(question, "Please set the position and direction of ship " + shipClass.getName() + " with length "
		        + shipClass.getSize() + "\n" + "Position should be between A-J and between 1-10");

		System.out.printf(question, "Position should be like A3");
		System.out.printf(prompt, ">>>");
	}

	@Override
	public void showShipDirectionView(ShipClass shipClass) {
		System.out.printf(question, "Please set the direction of ship " + shipClass.getName() + " with length " + shipClass.getSize());
